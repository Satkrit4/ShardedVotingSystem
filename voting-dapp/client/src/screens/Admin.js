...
export default function Admin({ role, contract, aggregatorContract, web3, currentAccount }) {
  ...
  const getFinalResults = async () => {
      ...
      const results = await aggregatorContract.methods.aggregateResults().call();
            ...
            {electionState === 2 && (
              <Grid item xs={12}>
                ...
                {finalResults.map((result, index) => (
                  <Typography key={index} align="center" variant="body1">
